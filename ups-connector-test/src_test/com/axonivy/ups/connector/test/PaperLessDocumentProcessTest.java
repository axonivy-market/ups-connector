...
public class PaperLessDocumentProcessTest extends BaseSetup {
  ...
  void testUploadPaperlessDocument(ExtensionContext context, BpmClient bpmClient) throws NoSuchFieldException {
    BpmElement startable =
        PAPERLESS_DOCUMENTS.elementName("uploadPaperlessDocument(String,String,String,String,UploadRequest)");
    ExecutionResult result =
        bpmClient.start().subProcess(startable).execute("test", "test", "test", "test", new UploadRequest());
